...
AUTOBOOT_SRC_URI = " \
    ...
    "
SRC_URI:append:intel-ast2500-sam += "${@bb.utils.contains('IMAGE_FSTYPES', 'intel-pfr', PFR_SRC_URI, '', d)}"
SRC_URI:append:intel-ast2500-sam += "${@bb.utils.contains('EXTRA_IMAGE_FEATURES', 'debug-tweaks', '', AUTOBOOT_SRC_URI, d)}"
do_install:append () {
